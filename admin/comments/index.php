...
{
    $com = Comment::find_by_id($_GET['delete']);
    if($com)
    {
        $com->delete();
        redirect('index.php');
...
<div class="content">
    <div class="middle"><!-- start middle -->
        <h1 class="title-box">نمایش نظرات</h1>
            ...
            <table cellspacing="0">
                ...
                ?>
                    <tr>
                        ...
                        <td><?= $comment->body ?></td>
                        <td><img src="../<?php $photo=Photo::find_by_id($comment->photo_id); echo $photo->picture_path(); ?>" width="30" height="30" style="border-radius: 50%;" /></td>
                        <td><a href="?delete=<?= $comment->id; ?>"><img src="../images/del.png" width="25" height="25"></a></td>
                    </tr>
                <?php } ?>
